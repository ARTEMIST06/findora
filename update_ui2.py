...
replace_label('Current Price', 'price')
replace_label('MRP', 'originalPrice')
replace_label('Merchant Product ID', 'merchantProductId')
replace_label('Original Product URL', 'productUrl')
replace_label('Availability', 'availability')

with open('src/pages/admin/AdminDashboard.tsx', 'w') as f:
    f.write(code)

print("done update_ui2")
